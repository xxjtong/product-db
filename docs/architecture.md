...
| 产品 | 396 个 |
| 测试 | pytest 665（664 passed + 1 skipped）+ vitest 101 + E2E 102（7 个 spec 套件，其中 100 条进 CI） |

> 统计于 2026-09-22（R78 后），数据为生产库实测值。
...
└── tests/               # pytest 341 tests (5 rounds of coverage expansion)
